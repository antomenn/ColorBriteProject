...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let contentView = ContentView().environment(\.managedObjectContext, context).environmentObject(Time()).environmentObject(UniversalColor()).environmentObject(AudioPlayer()).environmentObject(GameKitHelper.sharedInstance)
